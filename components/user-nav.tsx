  ...
  return (
    <div className="relative">
      <button
        ...
        className="relative h-8 w-8 rounded-full bg-gray-200 overflow-hidden"
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-56 rounded-md border border-gray-200 bg-white shadow-lg">
          <div className="p-2">
            ...
            <button className="flex w-full items-center rounded-md px-2 py-1.5 text-sm hover:bg-gray-100">
              <svg
