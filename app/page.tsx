        ...
        <div className="grid gap-4 sm:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="rounded-lg border border-gray-200 bg-white shadow-sm">
            <div className="flex flex-row items-center justify-between space-y-0 p-4 sm:p-6 pb-2">
              <h3 className="text-lg sm:text-xl font-medium">Members</h3>
              <svg
          ...
          <div className="rounded-lg border border-gray-200 bg-white shadow-sm">
            <div className="flex flex-row items-center justify-between space-y-0 p-4 sm:p-6 pb-2">
              <h3 className="text-lg sm:text-xl font-medium">Events</h3>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
            ...
            <div className="p-4 sm:p-6 pt-0">
              <div className="text-2xl sm:text-3xl font-bold">{loading ? "..." : stats.eventCount}</div>
          ...
          <div className="rounded-lg border border-gray-200 bg-white shadow-sm">
            <div className="flex flex-row items-center justify-between space-y-0 p-4 sm:p-6 pb-2">
              <h3 className="text-lg sm:text-xl font-medium">Attendance</h3>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
            ...
            <div className="p-4 sm:p-6 pt-0">
              <div className="text-2xl sm:text-3xl font-bold">{loading ? "..." : `${stats.attendanceRate}%`}</div>
          ...
          <div className="rounded-lg border border-gray-200 bg-white shadow-sm">
            <div className="flex flex-row items-center justify-between space-y-0 p-4 sm:p-6 pb-2">
              <h3 className="text-lg sm:text-xl font-medium">Cell Groups</h3>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
            ...
            <div className="p-4 sm:p-6 pt-0">
              <div className="text-2xl sm:text-3xl font-bold">{loading ? "..." : stats.cellGroupCount}</div>
          ...
          <div className="rounded-lg border border-gray-200 bg-white shadow-sm">
            <div className="flex flex-row items-center justify-between space-y-0 p-4 sm:p-6 pb-2">
              <h3 className="text-lg sm:text-xl font-medium">Reports</h3>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
            ...
            <div className="p-4 sm:p-6 pt-0">
              <div className="text-2xl sm:text-3xl font-bold">Analytics</div>
